    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <ul class="breadcrumb">
          ...
          <li class="active">Tambah Nutrien Ternak</li>
        </ul>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Tambah Nutrien Ternak</h2>
        </div>
        <div class="panel-body">
            {!! Form::open(['url' => route('requirementnutrients.store'), 'method' => 'post', 'class'=>'form-horizontal']) !!} 
