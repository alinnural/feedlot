...
@section('title')
  Tambah Nutrisi - Admin {{ config('configuration.site_name') }}
@endsection
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <ul class="breadcrumb">
          ...
          <li class="active">Tambah Nutrient</li>
        </ul>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h2 class="panel-title">Tambah Nutrient</h2>
        </div>
        <div class="panel-body">
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="form">
                <br><br>
                {!! Form::open(['url' => route('nutrients.store'), 'method' => 'post', 'class'=>'form-horizontal']) !!} 
